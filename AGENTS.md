...
For web or api, make sure you run `bun run build`, `bun run lint`, `bun run test:unit`, and `bun run test:e2e` anytime you make major changes and fix issues that arise.
