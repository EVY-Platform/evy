...
//
//   let rPCFlowUpdatedNotification = try RPCFlowUpdatedNotification(json)

import Foundation

/// JSON-RPC notification payload for flowUpdated event
// MARK: - RPCFlowUpdatedNotification
struct RPCFlowUpdatedNotification: Codable {
    let createdAt: Date
    let data: SDUIFlow
    let id: String
    let updatedAt: Date
...
// MARK: RPCFlowUpdatedNotification convenience initializers and mutators

extension RPCFlowUpdatedNotification {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(RPCFlowUpdatedNotification.self, from: data)
    }
    ...
    func with(
        ...
        id: String? = nil,
        updatedAt: Date? = nil
    ) -> RPCFlowUpdatedNotification {
        return RPCFlowUpdatedNotification(
