/* eslint-disable */
/** Generated from schema/rpc/get.response.schema.json - do not edit. */

/**
 * Response for get method (SDUI: array of SDUI_Flow; other: key-value object)
 */
export type GetResponse = GetSDUIResponse | GetDataResponse;
export type GetSDUIResponse = SDUI_Flow[];
